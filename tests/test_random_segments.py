...
class TestPoissonSegmentation(unittest.TestCase):
    def test_with_first_and_final_segment(self):
        ...
        segments = poisson_segmentation(iterable, lam=1, omit_first_and_last=False)
    ...
    def test_large_lam(self):
        ...
        segments = poisson_segmentation(iterable, lam=lam, omit_first_and_last=False)
    ...
    def test_mean_close_to_lambda(self):
        ...
        for lam in range(5, 15, 2):
            ...
            self.assertAlmostEqual(mean_len, lam, delta=0.2)
...
class TestKernSegmentExtraction(unittest.TestCase):
    def test_extract_from_file(self):
        ...
        np.random.seed(0)
        segments = extract_random_segments_from_file(
            path, lam=2, omit_first_and_last=False
        )
